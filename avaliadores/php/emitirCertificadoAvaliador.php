<?php
	...
	if(count($avaliadordados) > 0) {
		...
		$certificadoTexto = '<spam style="display: none;">á</spam>Certificamos que '.convertem(utf8_decode($nome),1).' foi avaliador(a) de resumos, apresentados na forma de pôsteres, no '.utf8_decode($avaliadordados[0]["edicao"]).' 
	...
	$certificadoTexto = '<spam style="display: none;">á</spam>Certificamos que '.convertem(utf8_decode($nome),1).' foi avaliador(a) de trabalhos apresentados sob a
