<?php
	...
	$eid = $_GET['id'];
	$db = new Database();
	$sql = "SELECT resumos.*,eventos.edicao,eventos.inicio,resumos.usuarios_id FROM resumos INNER JOIN eventos ".
		"ON resumos.eventos_id=eventos.id WHERE resumos.eventos_id='".
		$_GET['id']."' ORDER BY resumos.sessoes_id,resumos.cursos_id,".
